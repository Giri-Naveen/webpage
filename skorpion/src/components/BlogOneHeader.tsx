...
const BlogOneHeader = () => {
  return (
    <section id='hero' data-section className="w-full py-28 flex flex-col items-center justify-center bg-white relative">
      ...
      <SimpleReveal>
        <h1 className="text-6xl md:text-[68px] font-light font-sans text-black text-start mt-16">How to Build a <span className='font-semibold'>Successful</span></h1>
      </SimpleReveal>
      
      <SimpleReveal>
        <h1 className="text-6xl md:text-[68px] font-light font-sans text-black text-start mt-3"><span className='font-semibold'>Restaurant </span>in 10 Simple Steps</h1>
      </SimpleReveal>
    </section>
  );
};
