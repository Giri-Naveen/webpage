...
const AboutUsHeaderSection = () => {
    return (
    <section data-section id='hero' className="w-full py-28 px-40 flex flex-col items-start bg-gray-100">
      <div className="relative flex w-full mt-10">
        <SimpleReveal>
          <div className="absolute right-[102%] top-1/2 w-full border-t border-gray-300" />
        </SimpleReveal>
        <SimpleReveal>
        <div className="bg-gray-100 px-0 z-10 text-[14px] whitespace-nowrap">
      ...
      <SimpleReveal>
      <h1 className="text-6xl md:text-[74px] font-light font-sans text-black text-start mt-16"><span className='font-semibold'>Innovating </span>Today</h1>
      </SimpleReveal>
      <SimpleReveal>
      <h1 className="text-6xl md:text-[74px] font-light font-sans text-black text-start mt-3"><span className='font-semibold'>Empowering </span>Tomorrow</h1>
      </SimpleReveal>
      ...
      >
        <SimpleReveal>
          <span className="tracking-widest text-[13px] font-semibold">OUR MISSION</span>
        </SimpleReveal>
        <SimpleReveal>
