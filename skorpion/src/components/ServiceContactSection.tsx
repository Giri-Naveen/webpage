  ...
  return (
    <section data-section className="bg-gray-100 text-black w-full px-40 py-28 font-sans">
      ...
      <div className="flex flex-col justify-center items-center text-center mt-16">
        <ScrollReveal>
        <h1 className="text-[48px] md:text-[68px] font-sans font-semibold leading-tight text-black">
            Reach Out to Our <span className="font-light">Friendly Team</span>
        </h1>
        </ScrollReveal>
        <ScrollReveal>
        <h2 className="text-[48px] md:text-[68px] font-sans font-semibold leading-tight text-black">
            <span className="font-light">We’re Here to </span>Listen, Assist and Build Together
        </h2>
        </ScrollReveal>
