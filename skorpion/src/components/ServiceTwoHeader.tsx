...
const ServiceTwoHeader = () => {
    ...
    <section data-section id='hero' className="w-full pt-28 px-8 md:px-8 lg:px-24 xl:px-40 flex flex-col items-start bg-white">
      ...
      <SimpleReveal>
      <h1 className="text-[34px] md:text-[54px] lg:text-[64px] xl:text-[74px] font-light font-sans text-black text-start mt-16 md:mt-14 lg:mt-16 leading-[1.0]"><span className='font-semibold'>Ecom</span></h1>
      </SimpleReveal>
      {/* <h1 className="text-6xl md:text-[74px] font-light font-sans text-black text-start mt-3"><span className='font-semibold'>and </span>Development</h1> */}
      ...
      >
        <SimpleReveal>
        <span className="tracking-widest text-black text-[12px] md:text-[13px] font-semibold">ABOUT SERVICE</span>
        </SimpleReveal>
