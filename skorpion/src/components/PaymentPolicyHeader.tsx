...
const PaymentPolicyHeader = () => {
    ...
    <section id="hero" data-section className="w-full py-28 px-8 md:px-8 lg:px-24 xl:px-40 flex flex-col items-start bg-black">
      ...
      <SimpleReveal>
        <h1 className="text-[34px] md:text-[64px] lg:text-[69px] xl:text-[74px] font-light font-sans text-white text-start mt-16 md:mt-14 lg:mt-16 leading-[1.0]"><span className='font-semibold'>Payment</span></h1>
      </SimpleReveal>
      <SimpleReveal>
...
export default PaymentPolicyHeader;
