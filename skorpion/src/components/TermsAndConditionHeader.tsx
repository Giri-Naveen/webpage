...
const TermsAndConditionHeader = () => {
    ...
    <section id="hero" data-section className="w-full py-28 px-40 flex flex-col items-start bg-black">
      ...
      <SimpleReveal>
        <h1 className="text-6xl md:text-[74px] font-light font-sans text-white text-start mt-16"><span className='font-semibold'>Terms </span>and</h1>
      </SimpleReveal>
      <SimpleReveal>
        <h1 className="text-6xl md:text-[74px] font-light font-sans text-white text-start mt-3"><span className='font-semibold'>Conditions</span></h1>
      </SimpleReveal>
