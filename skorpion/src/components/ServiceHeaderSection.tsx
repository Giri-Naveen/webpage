...
const ServiceHeaderSection = () => {
    return (
    <section data-section id='hero' className="w-full pt-28 px-40 flex flex-col items-start bg-black">
      ...
      <SimpleReveal>
      <h1 className="text-6xl md:text-[76px] font-light font-sans text-white text-start mt-16"><span className='font-semibold'>This is </span>what</h1>
      </SimpleReveal>
      <SimpleReveal>
      <h1 className="text-6xl md:text-[76px] font-light font-sans text-white text-start mt-3"><span className='font-semibold'>we do </span>Best</h1>
      </SimpleReveal>
      ...
      >
        <SimpleReveal>
          <span className="tracking-widest text-[#1ECDFE] text-[13px] font-semibold">OUR SERVICES</span>
        </SimpleReveal>
        <SimpleReveal>
